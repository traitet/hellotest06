...
class ACreateDocCarReqPage extends StatefulWidget {
   //======================================================================================
  // PARAMETER
  //======================================================================================
  final String email;

  ACreateDocCarReqPage({Key key, @required this.email}): super(key: key);  
  @override
  _ACreateDocCarReqPageState createState() => _ACreateDocCarReqPageState();
}

class _ACreateDocCarReqPageState extends State<ACreateDocCarReqPage> {
//======================================================================
// DECLARE TEXT EDIT CONTROLLER
//====================================================================== 
      //final _createdByController = TextEditingController()..text;
      final _nameController = TextEditingController()..text = 'Request Car';
      final _descriptionController = TextEditingController()..text = 'Requested car on 18 May 2020 '; 
...
// SAVE TO DB
//======================================================================               
              ADocModel myModel = ADocModel(docType: "CAR", id: _timestampstr,name: _nameController.text,description: _descriptionController.text, createdBy: widget.email,imageUrl: 'https://firebasestorage.googleapis.com/v0/b/hellotest06-88fae.appspot.com/o/download.png?alt=media&token=7193690e-bd2b-4880-b949-8267024beed6');
